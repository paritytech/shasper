...
pub fn engine_tests<E: Engine>() where E: ::std::fmt::Debug, E::Fqk: ::std::fmt::Debug {
...
fn random_miller_loop_tests<E: Engine>() where E: ::std::fmt::Debug, E::Fqk: ::std::fmt::Debug {
    let mut rng = XorShiftRng::from_seed([0x5dbe6259, 0x8d313d76, 0x3237db17, 0xe5bc0654]);
...
fn random_bilinearity_tests<E: Engine>() where E: ::std::fmt::Debug, E::Fqk: ::std::fmt::Debug {
    let mut rng = XorShiftRng::from_seed([0x5dbe6259, 0x8d313d76, 0x3237db17, 0xe5bc0654]);
