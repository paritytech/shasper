...
fn verify_attestation(
	...
	let attestation_indices = crystallized.shards_and_committees_for_slots[attestation.slot as usize].iter().find(|v| v.shard_id == attestation.shard_id).expect("Attestation must exist").committee.clone();
