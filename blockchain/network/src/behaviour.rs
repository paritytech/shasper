...
#[behaviour(out_event = "BehaviourEvent<C>", poll_method = "poll")]
...
impl<C: Config, TSubstream: AsyncRead + AsyncWrite> Behaviour<C, TSubstream> {
    ...
    fn poll<TBehaviourIn>(
        &mut self,
    ) -> Async<NetworkBehaviourAction<TBehaviourIn, BehaviourEvent<C>>> {
...
pub enum BehaviourEvent<C: Config> {
