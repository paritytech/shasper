...
impl libp2p::core::ProtocolName for RPCType {
	fn protocol_name(&self) -> &[u8] {
		match self {
			RPCType::Hello => b"/eth2/beacon_chain/req/status/1",
			RPCType::Goodbye => b"/eth2/beacon_chain/req/goodbye/1",
			RPCType::BeaconBlocks => b"/eth2/beacon_chain/req/beacon_blocks_by_range/1",
			RPCType::RecentBeaconBlocks => b"/eth2/beacon_chain/req/beacon_blocks_by_root/1",
		}
	}
}
